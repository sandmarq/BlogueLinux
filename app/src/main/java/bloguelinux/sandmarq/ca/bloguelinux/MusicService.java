...
/**
 * Created by SANDRINE.MARQUIS on 2014-12-12. http://sapandiwakar.in/tutorial-how-to-manually-create-android-media-player-controls/
 */
public class MusicService extends Service implements MediaPlayer.OnPreparedListener, MediaPlayer.OnErrorListener, MediaPlayer.OnBufferingUpdateListener {
    ...
    void setUpAsForeground(String text) {
        ...
        mNotification.icon = R.drawable.tux;
